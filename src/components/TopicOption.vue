...
export default {
    ...
    computed: {
        topicOptions() {
            return [
                { value: 0, label: "General Knowledge" },
                { value: 1, label: "Entertainment: Books" },
                { value: 2, label: "Entertainment: Film" },
                { value: 3, label: "Entertainment: Music" },
    ...
    watch: {
        topic(newTopic) {
            this.$emit("topic-updated", newTopic);
        },
    },
};
</script>
